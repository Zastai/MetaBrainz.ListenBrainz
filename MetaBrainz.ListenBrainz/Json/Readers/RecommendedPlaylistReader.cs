...
internal sealed class RecommendedPlaylistReader : ObjectReader<RecommendedPlaylist> {
  public static readonly RecommendedPlaylistReader Instance = new();

  protected override RecommendedPlaylist ReadObjectContents(ref Utf8JsonReader reader, JsonSerializerOptions options) {
    int? count = null;
    int? offset = null;
